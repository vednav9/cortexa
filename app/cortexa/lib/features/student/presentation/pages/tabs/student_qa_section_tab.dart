...
import '../../../../teacher/data/models/qa_item_model.dart';
import '../../../../teacher/data/repositories/qa_section_repository.dart';
...
class _StudentQASectionTabState extends State<StudentQASectionTab> {
  ...
  List<QAItem> get _filteredQAs {
    ...
    switch (_sortBy) {
      ...
      case '-views':
        ...
        break;
      case '-upvotes':
        result.sort((a, b) => b.upvotes.length.compareTo(a.upvotes.length));
        break;
    }
    return result;
  }
  ...
  void _showError(String msg, [BuildContext? modalCtx]) {
    if (!mounted) return;
    final c = (modalCtx != null && modalCtx.mounted) ? modalCtx : context;
                        ...
                        children: [
                          ...
                          _sendButton(
                            ...
                            onTap: () async {
                              ...
                              try {
                                final updated = await _repo.addAnswer(
                                    current.id, text);
                                setSheet(() {
                                  current = updated;
        ...
        children: [
          ...
          const Text('No Courses Available',
              style: TextStyle(
                  ...
                  color: AppColors.textPrimary)),
          const SizedBox(height: 8),
          const Text('No courses found for your institution.',
              style: TextStyle(
          ...
          const Expanded(
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 3),
                Text(
                  'Ask and answer questions across your courses',
                  style: TextStyle(
        ...
        children: [
          Row(
            children: [
              ...
              const SizedBox(width: 8),
              statCard(
                  'Open', _stats.open, Icons.help_outline, Colors.orange),
            ],
          ),
          const SizedBox(height: 8),
          Row(
...
class _StudentUpvoteButton extends StatefulWidget {
  const _StudentUpvoteButton(
      {required this.isUpvoted, required this.onTap});
  final bool isUpvoted;
  final VoidCallback onTap;

  @override
  State<_StudentUpvoteButton> createState() => _StudentUpvoteButtonState();
}

class _StudentUpvoteButtonState extends State<_StudentUpvoteButton> {
  late bool _upvoted;
  ...
  @override
  void didUpdateWidget(_StudentUpvoteButton old) {
