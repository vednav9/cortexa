...
class _DepartmentsTabState extends State<DepartmentsTab> {
  ...
  void _showAddDepartmentDialog([Map<String, dynamic>? department, int? index]) {
              ...
              Flexible(
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        isEditing ? 'Update ${TerminologyService.getOrganizationalUnitLabel(context)}' : 'Add ${TerminologyService.getOrganizationalUnitLabel(context)}',
                      ...
                      Text(
                        isEditing ? 'Update ${TerminologyService.getOrganizationalUnitLabel(context).toLowerCase()} information' : 'Create a new academic ${TerminologyService.getOrganizationalUnitLabel(context).toLowerCase()}',
                        style: TextStyle(
                          fontSize: 14,
                      ...
                      const SizedBox(height: 20),
                      Text(
                        TerminologyService.getOrganizationalUnitFields(context).descriptionLabel,
                        style: const TextStyle(
                          fontSize: 14,
                          fontWeight: FontWeight.w600,
                          color: AppColors.textPrimary,
                      ...
                      TextField(
                        ...
                        maxLines: 4,
                        decoration: InputDecoration(
                          hintText: TerminologyService.getOrganizationalUnitFields(context).descriptionHint,
                          hintStyle: TextStyle(
                            color: AppColors.textTertiary.withValues(
                              alpha: 0.5,
                            ),
  ...
  void _createDepartment() {
    ...
    _storage.saveDepartment(departmentData);
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text('${TerminologyService.getOrganizationalUnitLabel(context)} created successfully'),
  ...
  void _updateDepartment(int index) {
    if (_nameController.text.trim().isEmpty ||
        _codeController.text.trim().isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
    ...
    final updatedDepartment = {
      ...
      'code': _codeController.text.trim().toUpperCase(),
      'description': _descriptionController.text.trim(),
      'createdAt': _departments[index]['createdAt'],
    };

    _storage.updateDepartment(_departments[index]['id'], updatedDepartment);
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text('${TerminologyService.getOrganizationalUnitLabel(context)} updated successfully'),
        backgroundColor: AppColors.success,
        behavior: SnackBarBehavior.floating,
        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(8)),
      ),
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        actions: [
          ...
          TextButton(
            onPressed: () {
              final departmentId = _departments[index]['id'];
              _storage.deleteDepartment(departmentId);
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(
                  content: Text('${TerminologyService.getOrganizationalUnitLabel(context)} deleted successfully'),
                  backgroundColor: AppColors.success,
                  behavior: SnackBarBehavior.floating,
                  shape: RoundedRectangleBorder(
              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Text(
                        TerminologyService.getOrganizationalUnitLabel(context, plural: true),
                        style: const TextStyle(
                          color: AppColors.textPrimary,
                          fontSize: 28,
                          fontWeight: FontWeight.bold,
                      ...
                      Text(
                        TerminologyService.getOrganizationalUnitDescription(context),
                        style: TextStyle(
                          color: AppColors.textSecondary.withValues(alpha: 0.9),
                          fontSize: 14,
                          height: 1.4,
            ...
            ClipRRect(
              ...
              child: Container(
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    hintText: 'Search ${TerminologyService.getOrganizationalUnitLabel(context, plural: true).toLowerCase()}...',
                    hintStyle: TextStyle(
