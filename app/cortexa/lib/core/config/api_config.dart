...
enum BackendConnectionMode { production, local, ngrok }
...
class ApiConfig {
  ...
  static Future<void> initialize() async {
    try {
      final secrets = await _channel.invokeMapMethod<String, String>(
        'getSecrets',
      );
  ...
  static const String _ngrokBackendUrl =
      'https://2d5c-223-236-96-72.ngrok-free.app';
  ...
  // Student MCQ
  static const String studentGetAssignedMCQs = '/student-mcq/mcq/assigned';
  static String studentGetMCQDetails(String mcqSetId) =>
      '/student-mcq/mcq/$mcqSetId/details';
  static String studentSubmitMCQ(String mcqSetId) =>
      '/student-mcq/mcq/$mcqSetId/submit';
  ...
  static const String teacherDeleteDocument =
      '/teacher/notes'; // + /{documentId}
