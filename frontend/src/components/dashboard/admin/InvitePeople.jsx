// InvitePeople.jsx - Admin feature for adding/inviting users
...
const InvitePeople = ({ institution }) => {
    const { user } = useAuth();
    ...
    const handleFile = (file) => {
        ...
        reader.onload = (e) => {
            ...
            toast.success(`${parsedUsers.length} users added from CSV`);
        };
    ...
    const handleManualSubmit = (e) => {
        e.preventDefault();
        setUsers([...users, { id: Date.now(), ...manualForm, userType }]);
        toast.success(`${manualForm.fullName} added successfully`);
        setManualForm({
            fullName: "",
            email: "",
            mobile: "",
    ...
    return (
        <div className="p-6 space-y-6">
            {/* Header with Stats */}
            <div className="relative overflow-hidden bg-gradient-to-br from-blue-500 via-blue-600 to-indigo-600 rounded-2xl p-8 text-white shadow-xl">
                ...
                <div className="relative z-10">
                            ...
                            <div className="flex items-center gap-3 mb-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-blue-100 text-sm mt-1">
                                        Add students and teachers to your institution
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
                        <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20">
                            <p className="text-blue-100 text-xs font-medium uppercase">Total Added</p>
                            <p className="text-3xl font-bold mt-1">{users.length}</p>
                        </div>
                        <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20">
                            <p className="text-blue-100 text-xs font-medium uppercase">Students</p>
                            <p className="text-3xl font-bold mt-1">
                                {users.filter((u) => u.userType === "student").length}
                            </p>
                        </div>
                        <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20">
                            <p className="text-blue-100 text-xs font-medium uppercase">Teachers</p>
                            <p className="text-3xl font-bold mt-1">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="relative z-10 flex items-center gap-4">
                        <div
                            className={`w-14 h-14 rounded-xl flex items-center justify-center flex-shrink-0 ${
                                uploadMethod === "csv" ? "bg-blue-500" : "bg-gray-100"
                            }`}
                        >
                ...
                >
                    <div className="relative z-10 flex items-center gap-4">
                        <div
                            className={`w-14 h-14 rounded-xl flex items-center justify-center flex-shrink-0 ${
                                uploadMethod === "manual" ? "bg-blue-500" : "bg-gray-100"
                            }`}
                        >
                            <FiEdit2
                                className={`w-7 h-7 ${uploadMethod === "manual" ? "text-white" : "text-gray-600"}`}
                            />
                        </div>
                        <div className="flex-1 text-left">
                    ...
                    >
                        ...
                        <div className="border-b border-gray-100 p-6 bg-gradient-to-r from-gray-50 to-white">
                            <div className="flex items-center justify-between flex-wrap gap-4">
                                ...
                                <motion.button
                                    ...
                                    className="flex items-center gap-2 px-5 py-3 bg-gradient-to-r from-blue-500 to-indigo-500 text-white font-semibold rounded-xl shadow-lg shadow-blue-200 hover:shadow-xl transition-all"
                                >
                        ...
                        <div className="p-8">
                            ...
                            >
                                ...
                                <motion.div animate={dragActive ? { scale: 1.1 } : { scale: 1 }} className="flex flex-col items-center">
                                    <div className="w-20 h-20 bg-gradient-to-br from-blue-500 to-indigo-500 rounded-2xl flex items-center justify-center shadow-xl mb-6">
                                ...
                                <div className="flex gap-4">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <div className="space-y-1 text-sm text-blue-800">
                                            <p>
                                                <strong>Required columns:</strong> Full Name, Email, Mobile, Year,
                                                Department, Division, Username
                                            </p>
                                            <p>
                                                <strong>Example:</strong> John Doe, john@example.com, 9876543210, BE,
                                                Computer Science, A, johndoe
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-gray-600 mt-0.5">
                                        Fill in the form to add one user at a time
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <form onSubmit={handleManualSubmit} className="p-8">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="space-y-2">
                                    ...
                                    <input
                                        ...
                                        className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all hover:border-gray-300"
                                    />
                                </div>
                                ...
                                <div className="md:col-span-2 space-y-2">
                                    ...
                                    <input
                                        ...
                                        onChange={(e) =>
                                            setManualForm({ ...manualForm, cortexaUsername: e.target.value })
                                        }
                                        required
                            ...
                            <div className="mt-8 pt-6 border-t border-gray-100 flex justify-end">
                                <motion.button
                                    ...
                                    whileTap={{ scale: 0.98 }}
                                    type="submit"
                                    className="inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-blue-500 to-indigo-500 text-white font-bold rounded-xl shadow-lg shadow-blue-200 hover:shadow-xl transition-all"
                                >
                        ...
                        <div className="bg-gradient-to-r from-blue-500 to-indigo-500 p-6 text-white">
                            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        <h3 className="text-2xl font-bold">
                                            {displayedUsers.length} {userType === "student" ? "Student" : "Teacher"}
                                            {displayedUsers.length !== 1 ? "s" : ""} Ready
                                        </h3>
                                        <p className="text-blue-100 text-sm mt-0.5">Review and upload to database</p>
                                    </div>
                                </div>
                                ...
                                <motion.button
                                    ...
                                    className="px-6 py-3.5 bg-white text-blue-600 font-bold rounded-xl hover:shadow-2xl transition-all flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                                >
                                    {uploading ? (
                                        <>
                                ...
                                <tbody className="divide-y divide-gray-100">
                                    {displayedUsers.map((user, index) => (
                                        ...
                                        >
                                            ...
                                            <td className="px-6 py-4 text-sm font-bold text-gray-900">{user.fullName}</td>
