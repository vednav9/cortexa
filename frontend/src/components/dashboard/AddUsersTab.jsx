...
const AddUsersTab = () => {
  ...
  const handleManualSubmit = (e) => {
    ...
    setManualForm({
      fullName: '', email: '', mobile: '', year: '', dept: '', division: '', cortexaUsername: ''
    });
  };
        ...
        <div className="relative z-10">
              ...
              <div className="flex items-center gap-3 mb-3">
                ...
                <div>
                  ...
                  {/* <p className="text-emerald-100 text-sm mt-1">
                    Manage your {userType === 'student' ? 'student' : 'teacher'} database
                  </p> */}
                </div>
              </div>
            </div>
          ...
          {/* <div className="grid grid-cols-3 gap-4 mt-6">
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20">
              <p className="text-emerald-100 text-xs font-medium uppercase">Total Added</p>
              <p className="text-3xl font-bold mt-1">{users.length}</p>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20">
              <p className="text-emerald-100 text-xs font-medium uppercase">Students</p>
              <p className="text-3xl font-bold mt-1">{users.filter(u => u.userType === 'student').length}</p>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20">
              <p className="text-emerald-100 text-xs font-medium uppercase">Teachers</p>
              <p className="text-3xl font-bold mt-1">{users.filter(u => u.userType === 'teacher').length}</p>
            </div>
          </div> */}
        </div>
      </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="space-y-1 text-sm text-blue-800">
                      <p><strong>Required columns:</strong> Full Name, Email, Mobile, Year, Department, Division, Username</p>
                      <p><strong>Example:</strong> John Doe, john@example.com, 9876543210, BE, Computer Science, A, johndoe</p>
                    </div>
                  </div>
                </div>
              </div>
